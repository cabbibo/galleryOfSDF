    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 color( float3 pos , float3 nor , float3 ro , float3 rd , float dist , float id){
                ...
                float3 col = hsv( _Parameter3 , 1,1);
                
                // if its our second sphere
                if( id == 2 ){
                    col = hsv(_Parameter4,1,1);
                }
